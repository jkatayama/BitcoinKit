...
cp "$TARGETDIR_IPHONEOS/lib/libsecp256k1.a" "$SCRIPT_DIR/../Libraries/secp256k1/lib/libsecp256k1.a"

#lipo -remove i386 "$TARGETDIR_IPHONEOS/lib/libsecp256k1.a"  -o "$TARGETDIR_IPHONEOS/lib/libsecp256k1.a"
#lipo -remove x86_64  "$TARGETDIR_SIMULATOR/lib/libsecp256k1.a" -o "$TARGETDIR_SIMULATOR/lib/libsecp256k1.a"
